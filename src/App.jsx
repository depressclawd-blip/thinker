        ...
        <section className="section gallery-section">
          <div className="gallery-grid">
            <div className="gallery-cell">
              <img src="/singa.jpg" alt="Lion" className="gallery-img" />
            </div>
            <div className="gallery-cell">
              <img src="/macan.jpg" alt="Tiger" className="gallery-img" />
            </div>
            <div className="gallery-cell">
              <img src="/pinguin.jpg" alt="Penguin" className="gallery-img" />
            </div>
            <div className="gallery-cell">
              <img src="/thinkerpfp.jpg" alt="THINKER" className="gallery-img" />
            </div>
            <div className="gallery-cell">
              <img src="/11.jpg" alt="THINKER gallery" className="gallery-img" />
            </div>
            <div className="gallery-cell">
              <img src="/12.jpg" alt="THINKER gallery" className="gallery-img" />
            </div>
            <div className="gallery-cell">
              <img src="/13.jpg" alt="THINKER gallery" className="gallery-img" />
            </div>
            <div className="gallery-cell">
              <img src="/14.jpg" alt="THINKER gallery" className="gallery-img" />
            </div>
            <div className="gallery-cell">
              <img src="/15.jpg" alt="THINKER gallery" className="gallery-img" />
            </div>
          </div>
        </section>
